...
public class DefaultWelcomePathSchemaTest
{

    @Rule
    public final ConfigSchemaRuleWithOptions schema = new ConfigSchemaRuleWithOptions()
    ...
    public void shouldValidateServerBinding()
    {
        ...
        logger.info("\nshouldValidateServerBinding... description: " + config);
    ...
    public void shouldValidateServerBindingWithOptions()
    {
        ...
        logger.info("\nshouldValidateServerBindingWithOptions... description: " + config);
        assertThat(config, not(nullValue()));
    }
    ...
    public void shouldRejectServerBindingWithoutCorrectOptions()
    {
        ...
        logger.info("\nshouldRejectServerBindingWithoutCorrectOptions... description: ");
    }
